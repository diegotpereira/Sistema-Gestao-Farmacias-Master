...
public class Sales_Bill extends javax.swing.JFrame {
	...
	private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informações de venda", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(255, 255, 255))); // NOI18N
	...
	protected void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
		// TODO Auto-generated method stub
		this.dispose();
		String sql = "delete from sales";
		    	...
		    	try{
		    		...
		    		if(res.next()){
		    			...
		    			if(res.getString("EXPIRY").equals("Expired")){
		    				...
		    				String sql1 = "insert into sales (BARCODE,NAME,TYPE,DOSE,QUANTITY,PRICE,AMOUNT,DATE) values ('"+Barcode+"','"+NAME+"' ,'"+TYPE+"','"+DOSE+"','"+quantity.getSelectedItem()+"','"+PRICE+"','"+AMOUNT+"','"+Farmacia.today.getText()+"')" ;
		    				...
		    				String sql2 = "insert into history_sales (USER_NAME,BARCODE,NAME,TYPE,DOSE,QUANTITY,PRICE,AMOUNT,DATE,TIME) values ('"+Farmacia.username1.getText()+"','"+Barcode+"','"+NAME+"' ,'"+TYPE+"','"+DOSE+"','"+quantity.getSelectedItem()+"','"+PRICE+"','"+AMOUNT+"','"+Farmacia.today.getText()+"','"+Farmacia.time.getText()+"' )" ;       
