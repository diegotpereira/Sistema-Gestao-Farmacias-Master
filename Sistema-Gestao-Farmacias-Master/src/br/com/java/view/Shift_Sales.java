...
public class Shift_Sales extends javax.swing.JFrame{
	...
	private void initComponents() {
        ...
        jLabel1.setText("Formulário de Vendas de Turno");
...
>>>>>>> refs/remotes/origin/master
	...
	private void help_user() {
		...
		try {
			...
			} total.setText(String.valueOf(amount)+"R$"); // help_user
	...
	private void help_user1() {
		...
		try {
		    ...
		    total.setText(String.valueOf(amount)+"Reais"); // help_user1
